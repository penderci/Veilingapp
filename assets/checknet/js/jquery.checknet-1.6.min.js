            ...
            window.checknet.windowIsActive && b.ajax({url: a, cache: !1, type: "HEAD"}).done(function () {
                ...
                window.checknet.conIsActive ? (b("#netWarn").length && b("#netWarn").fadeOut("fast", function () {
                   ...
                   // (b("#netWarn").length || (b("body").prepend('<p id="netWarn">' + window.checknet.config.warnMsg + "</p>"), b("#netWarn").fadeIn("fast")), b('input[type="submit"]').attr("disabled", "disabled").addClass("tempDisabled"))
                    (b("#netWarn").length || (b("body").prepend('<p id="netWarn">' + window.checknet.config.warnMsg + "</p>"), b("#netWarn").fadeIn("fast")), b("#sync").attr("disabled", "disabled").addClass("tempDisabled"))
            });
            setTimeout(function () {
