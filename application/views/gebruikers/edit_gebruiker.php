...
<form ng-controller="EditGebruikerController" role="form" method="post"
      action='<?php echo base_url(); ?>gebruikers/update/<?php echo $id ?>'>
    <input class="form-control input-sm" id="var_rol_id" name="var_rol_id" value="<?php echo $rol_id ?>"
           style="display: none;">
                        ...
                        <td class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control input-sm" id="var_rol_id2" name="var_rol_id2"
                                           value={{type}} style="display: none;">
                                </div>
                            </div>
                        </td>
                    </tr>
