...
<form ng-controller="EditGebruikerController" role="form" method="post" action='<?php echo base_url();?>gebruiker/update/<?php echo $id ?>'>
    <input class="form-control input-sm" id="var_rol_id" value="<?php echo $rol_id ?>" style="display: none;">
