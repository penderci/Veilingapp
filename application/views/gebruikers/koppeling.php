        ...
        <div class="well bs-component">
            ...
            <div class="container">
                <div class="form-group-sm row">
                    ...
                    <div class="col-sm-3">
                        <select name="gebruiker" id="gebruiker" ng-model="gebruiker"
                                ng-options="g.id as g.naam for g in gebruikers" class="form-control input-sm" required>
                            <option></option>
                        </select>
                        <br>
                        <button type="submit" class="btn btn-default btn-xs" style="float: right;">Maak koppeling
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-11" style="position: absolute;left: 5%;top: 30%">
        <div style="height: 400px; overflow: auto;">
            ...
            <table class="table table-striped table-hover" style="font-size: 12px;">
                ...
                <tr ng-repeat="koppel in gekoppelde_gebruikers">
                    <td>{{koppel.naam}}</td>
                    ...
                    <td>
                        <a href="#"
                           ng-click="launch_dialog(koppel.koopt_voor_gebruiker_id, koppel.gebruiker_id, koppel.naam)"
                           class="btn-sm glyphicon glyphicon-trash" tooltip="Verwijder koppeling" tooltip-trigger
