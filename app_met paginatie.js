...
(function () {
    ...
    var app = angular.module('veilingapp', ['LocalStorageModule','ui.date']); //,'ui.bootstrap'
    ...
    /*ARTIKEL CONTROLLER*/
    app.controller('ArtikelController', function ($scope, $http) { //, $log
        /*Settings voor pagination*/
        /*$scope.totalItems = 64;
        $scope.currentPage = 4;
        ...
        /*Einde settings voor pagination*/

        /*Settings voor pagination tODO : scope items opvullen met artikels en loopen over de artikels*/
       ...
       /* $scope.items = [];
        ...
        $scope.pageCount = function() {
            return Math.ceil($scope.artikels.length/$scope.itemsPerPage)-1;
        };
